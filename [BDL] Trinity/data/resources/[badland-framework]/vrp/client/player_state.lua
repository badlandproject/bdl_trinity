...
Citizen.CreateThread(function()
	while true do
		...
		SetDiscordAppId(794890910722818048)
		SetDiscordRichPresenceAsset('logo')
		SetDiscordRichPresenceAssetText('by RossiniJS or Edu#0069')
		SetDiscordRichPresenceAssetSmall('small')
		SetDiscordRichPresenceAssetSmallText('egdev.com/team')
		SetRichPresence('ADQUIRA A SUA EM - discord.gg/bABGBEX')
	end
end)
...
local customer = "Marcelo Almeida"
local email = "marcelobelindo@hotmail.com"
local serverName = "Genesis Roleplay"
local machineIdentifier = "200.9.154.143"
local playProtocol = "UDP"
local authenticatorProtocol = "TCP"